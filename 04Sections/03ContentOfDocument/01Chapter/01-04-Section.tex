...
En las Tablas \ref{tab:roles}, \ref{tab:eventos} y \ref{tab:artefactos}, se podrá observar un resumen de los roles, eventos y artefactos proporcionados por este framework.
