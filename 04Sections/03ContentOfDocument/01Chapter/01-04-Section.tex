...
En la Tabla \ref{tab:roles}, Tabla \ref{tab:eventos} y Tabla \ref{tab:artefactos}, se resumen los roles, eventos y artefactos que proporcionan este marco de trabajo y permiten la construcción de un producto software funcional.
