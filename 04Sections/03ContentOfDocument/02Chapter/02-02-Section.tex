...
Después, cada HU fue dividida en tareas específicas, útiles para realizar un trabajo organizado y eficiente. A través de un análisis colaborativo y estricto con el equipo Scrum, cada tarea fue valorada en términos de prioridad y complejidad utilizando una vez más el \textbf{Planning Poker}.
...
A continuación, la Tabla \ref{tab:productBacklog} expone el Product Backlog generado y valorado bajo los criterios mencionados. Esto ayudará a la asignación de tareas durante la planificación de sprints.  
