...
\paragraph{Definición de la arquitectura}
...
\paragraph{Definición de la base de datos}
...
\paragraph{Diseño de los prototipos de interfaces}
...
\begin{figure}[H]
    ...
    \caption{Configuración para gestión del proyecto con Trello.}
    \label{fig:prototipoFigma}
\end{figure}

\paragraph{Configuración de herramientas de gestión del proyecto}
Por su parte para llevar una correcta gestión del proyecto y tomando en cuenta que se está utilizando Scrum, se optó por la herramienta Trello por su fácil integración hacia otros sistemas como GitHub. La Figura \ref{fig:gestionProyectoTrello} muestra cómo fue configurado el proyecto mediante Trello, donde se pueden ver cada una de las fases para que cada HU pueda ser completada exitosamente.
