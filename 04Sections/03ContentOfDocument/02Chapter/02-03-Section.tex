...
def register(*,
    ...
    return user
    \end{lstlisting}
    \caption{Endpoint de registro de usuario.}
    \label{fig:sprint1_register_endpoint}
\end{figure}
...
export default function LoginPage() {
  ...
  // ...
    ...
    \end{lstlisting}
    \caption{Componente de la página de inicio de sesión.}
    \label{fig:sprint1_login_page}
\end{figure}

\paragraph{Conexión a las DBMS}
...
export function ConnectionModal() {
  ...
  // ...
    ...
    \end{lstlisting}
    \caption{Componente del modal de conexión.}
    \label{fig:sprint1_connection_modal}
\end{figure}
