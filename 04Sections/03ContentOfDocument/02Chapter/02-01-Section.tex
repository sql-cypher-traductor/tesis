...
En la Figura \ref{fig:planificacion} se visualiza el número de horas que llevó completar cada actividad.
...
Para asegurar que el desarrollo del \textit{middleware} sea progresivo, se llevaron a cabo reuniones semanales con el Ph.D. Víctor Velepucha, quien también brindó una basta retroalimentación y seguimiento para que el proyecto mantenga una orientación alineada a los objetivos establecidos.